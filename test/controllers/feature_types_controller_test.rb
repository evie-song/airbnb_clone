...
class FeatureTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feature_type" do
    assert_difference("FeatureType.count") do
      post feature_types_url, params: { feature_type: { category: @feature_type.category, name: @feature_type.name } }
    end
  ...
  test "should update feature_type" do
    patch feature_type_url(@feature_type), params: { feature_type: { category: @feature_type.category, name: @feature_type.name } }
