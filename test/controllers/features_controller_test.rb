...
class FeaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feature" do
    assert_difference("Feature.count") do
      post features_url, params: { feature: { feature_type_id: @feature.feature_type_id, name: @feature.name } }
    end
  ...
  test "should update feature" do
    patch feature_url(@feature), params: { feature: { feature_type_id: @feature.feature_type_id, name: @feature.name } }
